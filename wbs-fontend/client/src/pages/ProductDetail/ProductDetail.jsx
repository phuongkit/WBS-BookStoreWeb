                                    ...
                                    <div className="col-md-7">
                                            ...
                                            {initialProductDetail?.sale && false ? (
                                                <>
                                                    ...
                                                    <div className="tietkiem">
                                                        ...
                                                        <b>
                                                            {numberWithCommas(
                                                                initialProductDetail.originPrice -
                                                                    initialProductDetail.salePrice,
                                                            )}{' '}
                                                            ₫
                                                        </b>{' '}
                                                        <span className="sale tw-max-w-[40px]">
                                                            -{initialProductDetail?.sale * 100 || 0}%
                                                        </span>
                                                    </div>
                                                </>
                                            ) : (
                                        ...
                                        <div className="soluong d-flex">
                                            ...
                                            <div className="input-number input-group mb-3">
                                                ...
                                                <label className="tw-ml-[20px]">
                                                    {initialProductDetail.availableQuantity || 0 } có sẵn
                                                </label>
                                            </div>
                                        </div>
                                        <div
                                        ...
                                        <div className="nutmua btn w-10 text-uppercase" onClick={handlePurchase}>
                                            Chọn mua
                                        </div>
                                        <div
                                            id="result"
